---
title: "Project 2: Swarm stats: relation clutersize and singletons"
output: html_notebook
---

Small bash script to download partial files:
...
`.stats-datasets`, created by swarm's `-s` option:
- All forest soils 18S V4 904 samples: all over the world
- 16S rRNA V3-V4: Mediterranean soils
...
setwd("C:\\Users\\Milena K\\OneDrive\\Documents\\Master_Biostudium\\Projekt_France\\Projects_Notebooks")
